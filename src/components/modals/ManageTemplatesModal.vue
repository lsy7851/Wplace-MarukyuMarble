...
<template>
  <BaseModal
      ...
      <div
        ...
        <div class="flex-1 min-w-0">
          ...
          <div class="flex items-center gap-2 mb-1.5">
            <button
              class="btn-rename p-1.5 border border-mm-bg-muted rounded-lg cursor-pointer bg-[#1f2937] text-mm-text-dim min-w-[32px] h-8 flex items-center justify-center shrink-0 hover:bg-[#374151]"
        ...
        <div class="flex gap-2 items-center shrink-0">
          <!-- Export Button -->
          <button
            class="btn-action p-2 border-none rounded-lg cursor-pointer min-w-[36px] h-9 flex items-center justify-center text-white transition-all duration-200 hover:-translate-y-0.5 hover:brightness-110 bg-gradient-to-br from-[#22c55e] to-[#16a34a]"
          ...
          <!-- Fly To Button -->
          <button
            class="btn-action p-2 border-none rounded-lg cursor-pointer min-w-[36px] h-9 flex items-center justify-center text-white transition-all duration-200 hover:-translate-y-0.5 hover:brightness-110 bg-gradient-to-br from-mm-blue to-mm-blue-dark"
          ...
          <!-- Delete Button -->
          <button
            class="btn-action p-2 border-none rounded-lg cursor-pointer min-w-[36px] h-9 flex items-center justify-center text-white transition-all duration-200 hover:-translate-y-0.5 hover:brightness-110 bg-gradient-to-br from-mm-error to-mm-error-dark"
          ...
          <!-- Toggle Button -->
          <button
            class="px-4 py-2 border-none rounded-lg cursor-pointer text-[0.85em] font-semibold min-w-[80px] transition-all duration-200 hover:brightness-110"
            :class="template.enabled
              ? 'bg-gradient-to-br from-mm-success to-mm-success-dark text-white'
              : 'bg-gradient-to-br from-mm-bg-light to-mm-bg-muted text-mm-text-dim'"
    ...
    <template #footer>
      <button
        class="px-4 py-2.5 border-none rounded-lg cursor-pointer font-semibold text-[0.9em] transition-all duration-200 bg-gradient-to-br from-mm-success to-mm-success-dark text-white hover:not-disabled:brightness-110 disabled:opacity-50 disabled:cursor-not-allowed"
        :disabled="templateStore.templates.length === 0"
        @click="enableAllTemplates">
        Enable All
      </button>
      <button
        class="px-4 py-2.5 border-none rounded-lg cursor-pointer font-semibold text-[0.9em] transition-all duration-200 bg-gradient-to-br from-mm-bg-light to-mm-bg-muted text-mm-text-dim hover:not-disabled:brightness-110 disabled:opacity-50 disabled:cursor-not-allowed"
        :disabled="templateStore.templates.length === 0"
