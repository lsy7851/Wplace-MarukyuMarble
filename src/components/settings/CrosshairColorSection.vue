<template>
    <div class="mb-4 grid grid-cols-3 gap-3 max-[500px]:gap-2">
      ...
      <button
        ...
        :key="color.name"
        class="color-button relative flex h-[90px] cursor-pointer flex-col items-center justify-center gap-1 rounded-xl border-2 border-white/30 p-2.5 font-[inherit] shadow-[0_4px_12px_rgba(0,0,0,0.3)] transition-all duration-200 ease-in-out hover:scale-105 hover:border-white/70 max-[500px]:h-[75px] max-[500px]:p-2"
        ...
        <div v-if="isColorSelected(color)" class="absolute right-[5px] top-[5px] text-lg font-bold text-white [text-shadow:1px_1px_2px_rgba(0,0,0,0.8)]">✓</div>
      </button>

      <!-- Custom color button with RGB inputs -->
      <div
        class="custom-color relative flex h-[90px] cursor-pointer flex-col items-center justify-center gap-1 rounded-xl border-2 border-white/30 p-2.5 shadow-[0_4px_12px_rgba(0,0,0,0.3)] transition-all duration-200 ease-in-out hover:scale-105 hover:border-white/70 max-[500px]:h-[75px] max-[500px]:p-2"
        ...
        <div v-if="isCustomSelected" class="absolute right-[5px] top-[5px] text-lg font-bold text-white [text-shadow:1px_1px_2px_rgba(0,0,0,0.8)]">✓</div>
      </div>
    </div>
</template>
