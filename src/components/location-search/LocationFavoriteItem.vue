...
<template>
  <div
    class="flex cursor-pointer items-center gap-3 rounded-lg border border-white/10 bg-mm-bg-darkest/40 p-3 transition-all duration-200 ease-in-out hover:bg-mm-bg-dark/60"
    @click="handleClick">
