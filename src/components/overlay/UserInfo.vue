...
<template>
  <div id="bm-contain-userinfo" class="flex flex-col gap-[0.375rem] mt-[0.5em] transition-[opacity,height] duration-200 ease-in-out">
    <!-- Username -->
    <div v-if="showUsername" id="bm-user-name" class="flex items-center gap-[0.375rem]">
    ...
    <!-- Droplets -->
    <div v-if="showDroplets" id="bm-user-droplets" class="flex items-center gap-[0.375rem]">
    ...
    <!-- Next Level -->
    <div v-if="showNextLevel" id="bm-user-nextlevel" class="flex items-center gap-[0.375rem]">
    ...
    <!-- Full Charge Timer -->
    <div v-if="showFullCharge" id="bm-user-fullcharge" class="flex items-center gap-[0.375rem]">
