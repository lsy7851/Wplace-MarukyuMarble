...
<template>
  ...
  <button
    ...
    class="w-[56px] h-[38px] text-[20px] flex items-center justify-center bg-gradient-to-br from-mm-blue to-mm-blue-dark border-none rounded-lg cursor-pointer transition-all duration-200 ease-in-out mx-auto mt-1 hover:from-mm-blue-light hover:to-mm-blue hover:scale-105"
    title="Color Filter"
  ...
  <div
    ...
    <div class="toolbar flex gap-1.5 items-center mb-1.5">
      <div>
        <input
          ...
          class="flex-1 py-1 px-2 text-[11px] border border-white/20 rounded bg-white/10 text-white min-w-0 max-w-[120px]"
          type="text"
          @keydown.stop
          @keyup.stop
          @keypress.stop />
      ...
      <div>
        <select
          ...
          id="bm-color-sort"
          class="sort-select py-1 px-1.5 text-[11px] border border-white/20 rounded bg-white/10 text-white flex-1 min-w-[80px]">
    ...
    <div
      id="bm-color-list"
      ref="colorListRef"
      class="flex flex-col gap-[3px] max-h-[140px] overflow-y-auto"
      ...
      <div
        ...
        :key="color.colorKey"
        class="flex items-center gap-1.5 py-1.5 px-2 rounded border border-white/10 bg-white/5 text-[11px] leading-[1.3] min-h-[28px] transition-all duration-200 cursor-pointer hover:bg-white/10"
    ...
    <div
      ...
      <div class="w-[30px] h-[3px] bg-white/30 rounded-sm"></div>
    </div>
  </div>
</template>
